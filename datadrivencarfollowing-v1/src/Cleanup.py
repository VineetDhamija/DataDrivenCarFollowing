...
class Cleanup():
    ...
    def filter_records_for_model(self, df):
        ...
        print(f"{loc}: {both_lane_change_1.shape[0]} vehicles first and Last 5 seconds removed from Lane 1 due to lane changing")
        print(f"{loc}: {both_lane_change_2.shape[0]} vehicles first and Last 5 seconds removed from Lane 2 due to lane changing")
        print(f"{loc}: {both_lane_change_3.shape[0]} vehicles first and Last 5 seconds removed from Lane 3 due to lane changing")
        print(f"{loc}: {both_lane_change_4.shape[0]} vehicles first and Last 5 seconds removed from Lane 4 due to lane changing")
        print(f"{loc}: {both_lane_change_5.shape[0]} vehicles first and Last 5 seconds removed from Lane 5 due to lane changing")
        print(f"{loc}: {both_lane_change_6.shape[0]} vehicles first and Last 5 seconds removed from Lane 6 due to lane changing")
        print(f"{loc}: {both_lane_change_7.shape[0]} vehicles first and Last 5 seconds removed from Lane 7 due to lane changing")
        print(f"{loc}: {both_lane_change_8.shape[0]} vehicles first and Last 5 seconds removed from Lane 8 due to lane changing")
        print(f"{loc}: {bad_v_Class_length.shape[0]} have multiple lengths and classes for same Vehicle ID")
        ...
        remove = pd.concat(
            [time_headway_less_than5,total_duration_less_than_minute, bad_v_Class_length,both_lane_change_1,both_lane_change_2,both_lane_change_3,both_lane_change_4,both_lane_change_5,both_lane_change_6,both_lane_change_7,both_lane_change_8])
    ...
    def lane_change_info(self, df):
        lf_pair_remove_first_5_seconds_lane1,    lf_pair_remove_first_5_seconds_lane2,    lf_pair_remove_first_5_seconds_lane3,    lf_pair_remove_first_5_seconds_lane4,    lf_pair_remove_first_5_seconds_lane5,    lf_pair_remove_first_5_seconds_lane6,    lf_pair_remove_first_5_seconds_lane7,    lf_pair_remove_first_5_seconds_lane8=self.preceding_lane_change_data(df)
        lf_pair_remove_first_5_seconds_lane1_f,    lf_pair_remove_first_5_seconds_lane2_f,    lf_pair_remove_first_5_seconds_lane3_f,    lf_pair_remove_first_5_seconds_lane4_f,    lf_pair_remove_first_5_seconds_lane5_f,    lf_pair_remove_first_5_seconds_lane6_f,    lf_pair_remove_first_5_seconds_lane7_f,    lf_pair_remove_first_5_seconds_lane8_f=self.following_lane_change_data(df)

        lf_pair_remove_first_last_5_seconds_lane1=lf_pair_remove_first_5_seconds_lane1.append(lf_pair_remove_first_5_seconds_lane1_f)
        lf_pair_remove_first_last_5_seconds_lane2=lf_pair_remove_first_5_seconds_lane2.append(lf_pair_remove_first_5_seconds_lane2_f)
        lf_pair_remove_first_last_5_seconds_lane3=lf_pair_remove_first_5_seconds_lane3.append(lf_pair_remove_first_5_seconds_lane3_f)
        lf_pair_remove_first_last_5_seconds_lane4=lf_pair_remove_first_5_seconds_lane4.append(lf_pair_remove_first_5_seconds_lane4_f)
        lf_pair_remove_first_last_5_seconds_lane5=lf_pair_remove_first_5_seconds_lane5.append(lf_pair_remove_first_5_seconds_lane5_f)
        lf_pair_remove_first_last_5_seconds_lane6=lf_pair_remove_first_5_seconds_lane6.append(lf_pair_remove_first_5_seconds_lane6_f)
        lf_pair_remove_first_last_5_seconds_lane7=lf_pair_remove_first_5_seconds_lane7.append(lf_pair_remove_first_5_seconds_lane7_f)
        lf_pair_remove_first_last_5_seconds_lane8=lf_pair_remove_first_5_seconds_lane8.append(lf_pair_remove_first_5_seconds_lane8_f)

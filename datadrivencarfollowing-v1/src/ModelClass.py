...
class ModelClass():
    ...
    def plot_all_predictions(self, prediction_1, delta_time):
        self.combined_predicted_plots(prediction_1, 'pair_Time_Duration', 'knn_predicted_acceleration', 'rf_predicted_acceleration', 'cnn_predicted_acceleration',
                                      'nextframeAcc', 'Acceleration', delta_time, '')
        self.combined_predicted_plots(prediction_1, 'pair_Time_Duration', 'knn_predicted_velocity', 'rf_predicted_velocity', 'cnn_predicted_velocity',
                                      'nextframesvel', 'Velocity', delta_time, '')
